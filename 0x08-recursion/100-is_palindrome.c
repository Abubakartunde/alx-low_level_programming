...
/**
 *_strlen_recursion - is A function that obtain the length of the string s
...
/**
 * is_palindrome - is A function that checks if s is a palindrome string
 * @s: An inpuit string
 * Return: 1 if is string is a palindrome or 0 
 */
